...
//                                   </div>
//                                 )}
//                                 {/* Badge for reviewed sets on this day */}
//                                 {userCardSets.filter(cs => cs.lastReviewed && new Date(cs.lastReviewed).toDateString() === cell.date.toDateString()).length > 0 && (
//                                   <div className="mt-1">
//                                     <span className="inline-block bg-green-200 text-green-800 px-2 py-0.5 rounded-full text-xs">
//                                       Reviewed {userCardSets.filter(cs => cs.lastReviewed && new Date(cs.lastReviewed).toDateString() === cell.date.toDateString()).length}
//                                     </span>
//                                   </div>
//                                 )}
//                               </div>
