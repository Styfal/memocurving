  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row gap-6">
              ...
              {/* Suggestions for "Last Logged In" Replacement */}
              <div className="flex-1">
                <h2 className="text-2xl font-semibold mb-4 flex items-center">
                  <Users className="mr-2" />
                  Last Logged In
                ...
                {/*
                  Suggestions:
                  - Replace with "Recent Activity" to show a summary of recent interactions.
                  - Replace with "Last Session" with details of the last study session.
                  - Replace with a progress summary or personalized stats (e.g., "Time Spent Learning", "Cards Reviewed Today").
                */}
              </div>
              {/* Your Plan */}
              <div className="flex-1">
        ...
        {/* --- Review Calendar Section (Moved below Review Sessions Overview) --- */}
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between w-full">
              {/* Left arrows */}
