...
// Update the maximum number of cards to 20
const MAX_CARDS = 20
...
export default function CreateCardSet({ setCardSets, setNotification }: CreateCardSetProps) {
  ...
  // Commented out the optional image upload functionality
  /*
  ...
  */
  ...
  const removeFlashcard = (id: number) => {
    // Allow deletion even if it leaves no cards (you may add a confirmation if needed)
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Centered, larger "Add More Cards" button */}
