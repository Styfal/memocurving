...
//         // If the answer type is switched to "short", remove any existing options
...
//     <div className="mt-32 p-8 w-[60%] mx-auto flex flex-col items-center bg-gray-100">
...
//                   />
//                 </div>
//                 {/* Updated Delete Button with coherent styling */}
//                 <Button
