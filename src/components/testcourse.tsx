...
import { auth, db } from "@/lib/firebase"; // Use the correct path
  ...
  useEffect(() => {
    if (user) {
      ...
      const fetchTestsets = async () => {
        ...
        // Process the query result and store tests
        ...
        <div className="container max-w-5xl mx-auto">
          <section className="mb-12">
            <div className="flex items-center justify-between mb-4">
              ...
              {/* Adjust the "View More" link if needed */}
              <Link href="/tests">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {userTestsets.length > 0 ? (
                userTestsets.map((testset) => (
                  ...
                  >
                    <img
                      src={testset.imageUrl || "/placeholder.svg"} // Fallback image
                      alt={testset.title}
                      width={600}
                      height={300}
                    ...
                    />
                    {/* Link to the detailed test view */}
                    <Link
