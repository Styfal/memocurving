...
export default function TestCourse() {
  ...
  // Track which question rows are in "edit mode" (by index)
  ...
  // Open the edit modal for a specific test
  ...
  // Update a question's content in the editedQuestions state
  ...
  // Remove a question from the editedQuestions array
  const handleRemoveQuestion = (index: number) => {
    setEditedQuestions((prev) => prev.filter((_, i) => i !== index));
    setEditingIndices((prev) => prev.filter((i) => i !== index));
  };

  // Save changes made in the edit modal to the backend
              ...
              <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <Button
                  ...
                  onClick={() => {
                    ...
                    // Open the new question in edit mode.
