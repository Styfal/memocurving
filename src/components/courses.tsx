...
//   // Fetch the cardsets created by the current user using the createdBy.uid field.
//   useEffect(() => {
//     if (user) {
//       const fetchCardsets = async () => {
//         const q = query(
...
//     // Stop propagation so clicking delete doesn't activate surrounding links.
//     e.stopPropagation();
//     e.preventDefault();
...
//     try {
//       // Make a DELETE API call to the dynamic route for cardSets.
//       const response = await fetch(`/api/cardsets/${cardsetId}`, {
//         method: "DELETE",
//       });
//       const result = await response.json();
//       if (result.success) {
//         // Remove the deleted cardset from local state.
...
//                       style={{ aspectRatio: "600/300", objectFit: "cover" }}
//                     />
//                     {/* Absolute link to cardset details */}
//                     <Link
//                       href={`/cards/${cardset.id}`}
